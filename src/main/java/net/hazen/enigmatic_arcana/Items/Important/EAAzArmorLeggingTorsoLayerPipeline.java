...
public class EAAzArmorLeggingTorsoLayerPipeline extends AzArmorRendererPipelineContext {
    public EAAzArmorLeggingTorsoLayerPipeline(AzRendererPipeline<UUID, ItemStack> rendererPipeline) {
