...
@OnlyIn(Dist.CLIENT)
public class AgroconicBulwarkRenderer implements ICurioRenderer {
    private final AgroconicBulwarkItemRenderer curioRenderer = new AgroconicBulwarkItemRenderer();
